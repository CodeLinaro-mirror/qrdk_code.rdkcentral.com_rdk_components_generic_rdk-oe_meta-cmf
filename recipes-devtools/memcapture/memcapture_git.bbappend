SRC_URI:remove = "git://${RDK_GIT}/rdk/component/generic/performancetool/generic;protocol=${RDK_GIT_PROTOCOL};branch=${RDK_GIT_BRANCH};subpath=memcapture;name=script"
