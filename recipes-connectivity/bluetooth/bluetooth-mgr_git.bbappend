...
RDEPENDS_${PN}:remove_ipclient = "virtual/media-utils"
RDEPENDS_${PN}:remove_ipclient = "audiocapturemgr"

EXTRA_OECONF:remove_ipclient = "${ENABLE_ACM}"
EXTRA_OECONF:remove_ipclient = "${ENABLE_AC_RMF}"

CFLAGS:remove_ipclient = " ${@bb.utils.contains('RDEPENDS_${PN}', 'virtual/media-utils', ' -I${STAGING_INCDIR}/media-utils/audioCapture', ' ', d)}"
